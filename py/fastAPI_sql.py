...
from sqldatabase import DatabaseManager
...
class PostsResponseForUser(BaseModel):
    id: int
    title: str
    content: str
    created_at: str
...
@app.get("/users/{user_id}/posts/", response_model=List[PostsResponseForUser])
